class Car:
    ...
    def show_info(self):
        ...
        """
        print(self.brand_name + ' ' + self.model_name + ' Engine volume: ' +
              self.e_volume + ' Transmission: ' + self.transmission + ' Body type: '
              + self.body)

    def show_by_brand(self, brand):
        """ Prints info about car, if it's brand equals to parameter.
        """
    ...
    def show_by_tr(self, tr):
        """ Prints info about car, if it's transmisson equals to parameter.
        """
        if self.transmission == tr:
            print(self.brand_name + ' ' + self.model_name + ' Engine volume: '
                  + self.e_volume + ' Transmission: ' + self.transmission +
                  ' Body type: ' + self.body)
...
print("Please, enter the type of transmission, you want"+
      " to see on yor screen(AT or MT only):")
tr = input()
